<?php
// This PHP script is used to fetch the Philippine News Agency's articles page and convert it into an RSS Feed
// It is used because PNA has no RSS Feed (for some reason)
